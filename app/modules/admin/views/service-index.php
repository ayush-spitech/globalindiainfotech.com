							...
							<tbody>
								...
								if(isset($aGrid->rows) && is_array($aGrid->rows) && !empty($aGrid->rows)){
									...
									foreach ($aGrid->rows as $row) {	
										...
										?>
										<tr id='sequences_<?php echo $row->service_id; ?>'>
											<td><?php echo $i++?></td>
											<td><?php	
											...
											<td class="text-center">
												<a href="<?php echo $moduleUrl;?>add/<?php echo $row->service_id?>"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"><?php echo lang('Edit')?></i></a>
											</td>
										</tr>
										<?php
									}
