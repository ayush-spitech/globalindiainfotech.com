						...
						<table class="table table-bordered table-responsive">
							<thead>
								<tr>								
									...
									<th width="20%"><?php echo lang('Caption');?></th>
									<th width="50%"><?php echo lang('Short Description');?></th>
									...
									foreach ($aGrid->rows as $row) {	
										...
										<tr>
											...
											<td class="text-center">
												<a href="<?php echo $moduleUrl;?>add/<?php echo $row->banner_id?>"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"><?php echo lang('Edit')?></i></a>
											</td>
										</tr>
										<?php
									}
