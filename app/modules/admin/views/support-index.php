		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php show_message();?>					
					<?php get_search_form('',$moduleUrl,'Search By Service Name');?>				
					<!--GRID START-->
						...
						<table class="table table-bordered table-responsive row-sorting">
							<thead>
								<tr>								
									...
									<th width="5%"><?php echo lang('Thumbnail');?></th>
									<th width="8%"><?php echo lang('Featured&nbsp;Image');?></th>
									<th width="15%"><?php echo lang('Name');?></th>
									<th width="*"><?php echo lang('Description');?></th>	
							...
							<tbody>
								...
								if(isset($aGrid->rows) && is_array($aGrid->rows) && !empty($aGrid->rows)){
									...
									foreach ($aGrid->rows as $row) {	
										...
										?>
										<tr id='sequences_<?php echo $row->support_id; ?>'>
											<td><?php echo $i++?></td>
											<td><?php	
											...
											<td class="text-center">
												<a href="<?php echo $moduleUrl;?>add/<?php echo $row->support_id?>"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"><?php echo lang('Edit')?></i></a>
											</td>
										</tr>
										<?php
									}
