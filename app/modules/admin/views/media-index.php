									...
									foreach ($aGrid->rows as $row) {	
										...
										<tr>
											...
											<td class="text-center">
												<a href="<?php echo $moduleUrl;?>add_image/<?php echo $row->media_id;?>" title="Add Images">
													<i class="fa fa-plus"></i>&nbsp;<?php echo lang('Add Images');?>
												</a> &nbsp;
												<a href="<?php echo $moduleUrl;?>add/<?php echo $row->media_id?>"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"><?php echo lang('Edit')?></i></a>
											</td>
										</tr>
										<?php } 
									} 
