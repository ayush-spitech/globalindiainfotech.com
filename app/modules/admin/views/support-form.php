		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					$edit_id=0;
					$activeClass='';					
					if(isset($aContentInfo->support_id)){
						$edit_id=$aContentInfo->support_id;
						$activeClass='hide';
					}
					$attribute=array("id"=>"form1","method"=>"post","class"=>"form-horizontal");
					echo form_open_multipart('',$attribute);
					echo form_hidden('support_id',$edit_id);
					?>
					<fieldset>	
                       ...
                       <div class="form-group">
								...
								<div class="form-group">
									<label class="col-md-3 control-label"><?php echo lang('Description')?>
									</label>
									<div class="col-md-6">
										<?php
										$short_description='';
										...
										<textarea id="short_description" name="short_description" placeholder="<?php echo lang('Description')?>" class="form-control"><?php echo $short_description?></textarea>
