						...
						<table class="table table-bordered table-responsive row-sorting">
							<thead>
								<tr>								
                                    ...
                                    <th width="15%"><?php echo lang('Exam');?></th>
                                    <th width="25%"><?php echo lang('Rank');?></th>
									...
									foreach ($aGrid->rows as $row) {
										...
										<tr id='sequences_<?php echo $row->topper_id; ?>'>
											...
											<td class="text-center">
												...
												<a href="<?php echo $moduleUrl;?>add/<?php echo $row->topper_id?>" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"></i></a>
											</td>
										</tr>
