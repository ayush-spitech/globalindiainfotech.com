				...
				<div class="panel-body">
					...
					<fieldset>	
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><?php echo lang('Course Name')?>
									<span class="required">*</span></label>
									<div class="col-md-6">
										<?php 
										$caption='';
										...
										<input id="caption" name="caption" validate="Required" type="text" placeholder="<?php echo lang('Course Name')?>" class="form-control" value="<?php echo $caption?>">
										<div class="error" id="error_caption"></div>
									</div>
								</div>		

								<div class="form-group">
									<label class="col-md-3 control-label"><?php echo lang('Course Description')?>
									</label>
									<div class="col-md-6">
										<?php
										$short_description='';
										...
										<textarea id="short_description" name="short_description" placeholder="<?php echo lang('Course Description')?>" class="form-control"><?php echo $short_description?></textarea>
