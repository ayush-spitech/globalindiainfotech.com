						...
						<table class="table table-bordered table-responsive">
							<thead>
								<tr>								
									...
									<th width="10%"><?php echo lang('Datetime');?></th>
									<th width="15%"><?php echo lang('Name');?></th>
									<th width="12%"  class="text-center"><?php echo lang('Mobile');?></th>
									<th width="12%"><?php echo lang('Email');?></th>
                                    <th width="10%"><?php echo lang('Subject');?></th>
							...
							<tbody>
								...
								if(isset($aGrid->rows) && is_array($aGrid->rows) && !empty($aGrid->rows)){
									...
									foreach ($aGrid->rows as $row) {	
										...
										<tr>
											<td><?php echo $i++?></td>
											<td class="date"><?php echo config_date($row->created_date)?></td>	
											...
											<td class="action">
												<a class="delete" href="<?php echo $moduleUrl;?>delete/<?php echo $row->feedback_id?>"><i class="glyphicon glyphicon-remove" title="<?php echo lang('Delete')?>"><?php echo lang('Delete')?></i></a>
											</td>
										</tr>
										<?php
									}
