		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					$edit_id=0;
					$activeClass='';					
					if(isset($aContentInfo->industry_id)){
						$edit_id=$aContentInfo->industry_id;
						$activeClass='hide';
					}
					$attribute=array("id"=>"form1","method"=>"post","class"=>"form-horizontal");
					echo form_open_multipart('',$attribute);
					echo form_hidden('industry_id',$edit_id);
					?>
					<fieldset>	
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><?php echo lang('Industry Name')?>
									<span class="required">*</span></label>
									<div class="col-md-6">
										<?php 
										$caption='';
										...
										<input id="caption" name="caption" validate="Required" type="text" placeholder="<?php echo lang('Industry Name')?>" class="form-control" value="<?php echo $caption?>">
										<div class="error" id="error_caption"></div>
									</div>
								</div>		

								<div class="form-group">
									<label class="col-md-3 control-label"><?php echo lang('Industry Description')?>
									</label>
									<div class="col-md-6">
										<?php
										$short_description='';
										...
										<textarea id="short_description" name="short_description" placeholder="<?php echo lang('Industry Description')?>" class="form-control"><?php echo $short_description?></textarea>
										<?php full_ckeditor('short_description','700px','700px');?>
