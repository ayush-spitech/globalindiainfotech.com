		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php show_message();?>					
					<?php get_search_form('',$moduleUrl,'Search By Industry Name');?>				
					<!--GRID START-->
							...
							<tbody>
								...
								if(isset($aGrid->rows) && is_array($aGrid->rows) && !empty($aGrid->rows)){
									...
									foreach ($aGrid->rows as $row) {	
										...
										?>
										<tr id='sequences_<?php echo $row->industry_id; ?>'>
											<td><?php echo $i++?></td>
											<td><?php	
											...
											<td class="text-center">
												<a href="<?php echo $moduleUrl;?>add/<?php echo $row->industry_id?>"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"><?php echo lang('Edit')?></i></a>
											</td>
										</tr>
										<?php
									}
