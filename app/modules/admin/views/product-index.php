		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php show_message();?>					
					<?php get_search_form('',$moduleUrl,'Search By Product Name');?>				
					<!--GRID START-->
						...
						<table class="table table-bordered table-responsive row-sorting">
							<thead>
								<tr>								
									...
									<th width="20%"><?php echo lang('Product Name');?></th>
							...
							<tbody>
								...
								if(isset($aGrid->rows) && is_array($aGrid->rows) && !empty($aGrid->rows)){
									...
									foreach ($aGrid->rows as $row) {	
										...
										?>
										<tr id='sequences_<?php echo $row->product_id; ?>'>
											<td><?php echo $i++?></td>
											<td><?php	
											...
											<td class="text-center">
												<a href="<?php echo $moduleUrl;?>add/<?php echo $row->product_id?>"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"><?php echo lang('Edit')?></i></a>
											</td>
										</tr>
										<?php
									}
