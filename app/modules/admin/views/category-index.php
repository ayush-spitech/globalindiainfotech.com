		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php show_message();?>					
					<?php get_search_form('',$moduleUrl,'Search Category');?>				
					<!--GRID START-->
						...
						<table class="table table-bordered table-responsive">
							<thead>
								<tr>								
									...
									<th width="80%"><?php echo lang('Category Title');?></th>
								...
								if(isset($aGrid->rows) && is_array($aGrid->rows) && !empty($aGrid->rows)){
									...
									foreach ($aGrid->rows as $row) {	
										...
										<tr>
											...
											<td class="action">
												<a class="edit" href="<?php echo $moduleUrl;?>add/<?php echo $row->category_id?>"><i class="glyphicon glyphicon-pencil" title="<?php echo lang('Edit')?>"><?php echo lang('Edit')?></i></a>
												&nbsp;
												<a class="delete" href="<?php echo $moduleUrl;?>delete/<?php echo $row->category_id?>"><i class="glyphicon glyphicon-remove" title="<?php echo lang('Delete')?>"><?php echo lang('Delete')?></i></a>
											</td>
										</tr>
										<?php
									}
