				...
				<div class="panel-body">
					...
					<fieldset>	
						<div class="form-group">
							<label class="col-md-3 control-label"><?php echo lang('Gallery Category')?>
								</label>
								<div class="col-md-6">
									<?php 
									$title=$aContentInfo->title;
									?>
									<input disabled="disabled"  type="text" placeholder="<?php echo lang('Gallery Category')?>" class="form-control" value="<?php echo $title?>">									
								</div>
							</div>							
